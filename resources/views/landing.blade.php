...
<head>
  ...
  <!-- Favicons -->
  <link href="jeruk.ico" rel="icon">
  <link href="jeruk.ico" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <img src="jeruk.ico" alt="icon" width="5%">
      <h1 class="logo me-auto"><a href="{{route('landing')}}" style="text-decoration:none">Tentang Jeruk</a></h1>
    ...
    <form class="d-flex">
        <a class="btn btn-outline-light" role="button" href="https://api.whatsapp.com/send?phone=62859175451790">
