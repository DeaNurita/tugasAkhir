        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white mb-4">
                    <div class="card-body">{{ $rejectCountP }} Rejected Produk
                        @if ($rejectCountP > 0)
                            <div class="fas fa-bell float-end"></div>
                        @else
                            <div class="fas fa-check float-end"></div>
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="{{ route('product.index', ['approve' => '0']) }}">You have {{ $rejectCountP }} rejected Produk</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white mb-4">
                    <div class="card-body">{{ $approveCountC }} Approved Produk
                        @if ($approveCountC > 0)
                            <div class="fas fa-bell float-end"></div>
                        @else
                            <div class="fas fa-check float-end"></div>
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="{{ route('product.index', ['approve' => '1']) }}">You have {{ $approveCountC }} approved Produk</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
